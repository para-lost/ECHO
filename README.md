...
| `image_to_image` | 717 | Mirrors `image_to_image` in the academic version, but with synthetic input images generated by GPT-4o Image Gen from dense text captions. |
